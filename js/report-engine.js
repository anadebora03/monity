/* ============================================================
   COMPASSO · Report Engine — motor único de relatório clínico
   (Sprint 020)

   Existe UM relatório só. O app do paciente e o Compasso Pro
...
<title>Compasso · Relatório · ${reportEsc(p.nome)}</title>
<style>
:root{
...
<div class="ftr">Compasso · companheiro de tratamento GLP-1<br>Relatório gerado em ${reportFmtBRy(reportTodayISO())} · Este documento não substitui a avaliação do seu médico ou nutricionista.</div>
