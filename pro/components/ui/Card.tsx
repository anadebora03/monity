...
export function Card({ className = '', ...props }: HTMLAttributes<HTMLDivElement>) {
  return (
    <div
      {...props}
      className={`rounded-md border border-slate-100 bg-white p-4 shadow-card transition-shadow duration-200 ease-out dark:border-white/5 dark:bg-navy-soft dark:shadow-card-dark ${className}`}
    />
  );
}
